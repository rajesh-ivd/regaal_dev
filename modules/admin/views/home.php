          ...
          <div class="media d-block d-lg-flex">
            ...
            <div class="col-xl-12">
                    ...
                    echo '<div class="col-md-6">
                            <div class="card card-event">
                              ...
                              <div class="card-footer tx-13">
                                ...
                                <span class="del-icon">
                                  <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal2" onclick="home_banner_edit_data_desk('.$val->img_id.')"></i>';
                    if(count($home_banner_desk_data)>1){
                    	echo '<i class="fas fa-trash-alt text-danger" title="Delete" onclick=image_del("'.$val->img_id.'")></i>';
                    }
                    echo '</span>
                              </div>
                            </div>
              ...
              <div class="headerText">
                      ...
                      <button type="button" class="btn btn-warning" onclick="set_type_home('home_mob.php')" data-toggle="modal" data-target="#exampleModal">Upload Mobile Banner</button>
                    ...
                    echo '<div class="col-md-6">
                            <div class="card card-event">
                              ...
                              <div class="card-footer tx-13">
                                <span class="tx-color-03"></span>
                                <span class="del-icon">
                                  <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal2" onclick="home_banner_edit_data_mob('.$val->img_id.')"></i>';
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <input type="text" class="form-control" placeholder="Enter text" id="home_banner_text"><br>
                      <label for="home_banner_pic"><b id="type_text">Choose Image(1350x850):</b></label>
              ...
              <div class="modal fade" id="exampleModal2">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form" action="" onsubmit="return false">
                      <label for="home_banner_text_edit"><b>Banner Text:</b></label>
                      <input type="hidden" id="home_banner_edit_id" value="">
                      <input type="text" class="form-control" placeholder="Enter text" id="home_banner_text_edit"><br>
                      <label for="home_banner_pic_edit"><b id="type_text_edit">Choose Image(1350x850):</b></label>
                      <img src="#" id="show_pic" width="150px;" style="display: none;"><br>
                      <input type="file" id="home_banner_pic_edit" accept="image/png, image/jpg, image/jpeg" onchange="document.getElementById('show_pic').src = window.URL.createObjectURL(this.files[0])"><br>
                      <button type="submit" class="btn btn-success" onclick="home_banner_edit()">Update</button>
                      <p style="color: red; font-size: 15px;"><b id="home_banner_error"></b></p>
                      </form>
                    </div>
              ...
              <div class="tab-pane fade show" id="section1" role="tabpane2" aria-labelledby="section1-tab">
                <form class="form" action="" onsubmit="return false">
                  <div class="headerText">
                      ...
                      <button type="submit" class="btn btn-primary" onclick="home_section1_save()">Save</button>

                    </div>

                    <label for="home_section1_title">Title:</label>
                    <input type="text" class="form-control" placeholder="Enter title" id="home_section1_title" value="<?php echo $home_section1_data[0]->element_content;?>" required>
                    <label for="home_section1_text">Text:</label>
                    <textarea class="form-control" placeholder="Enter text" rows="4" id="home_section1_text" required><?php echo $home_section1_data[1]->element_content;?></textarea>
                  ...
                  <p><strong>Note: </strong>Please enter only the Vimeo Video ID. To get a Video ID you can open a video in vimeo and in the url bar you will find something similer to this - "https://vimeo.com/472927205", where "472927205" is the Video ID.
                  </p>
            ...
            <div class="col-xl-12">
              ...
              <div class="tab-pane fade show" id="section3" role="tabpane4" aria-labelledby="section3-tab">
                <form class="form" action="" onsubmit="return false">
                  ...
                  <br><h5>Background Image: (Desktop)</h5>

                  <div class="row">
                    <div class="col-xl-12">
                      <div class="row row-sm mg-b-25 crd">
                        <?php
                        if(isset($home_section3_pic_data_desk)){
                          foreach ($home_section3_pic_data_desk as $key => $val) {
                            echo '<div class="col-md-6">
                                    <div class="card card-event">
                                      <img src="'.base_url().'/uploads/'.$val->img_link.'" class="card-img-top" alt="">
                                      <div class="card-footer tx-13">
                                        <span class="tx-color-03"></span>
                                        <span class="del-icon">
                                          <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal5" onclick="home_section3_pic_data_desk('.$val->img_id.')"></i>
                                        </span>
                                      </div>
                                    </div>
                                  </div>';
                      ...
                      <br><h5>Background Image: (Mobile)</h5>

                  <div class="row">
                    <div class="col-xl-12">
                      <div class="row row-sm mg-b-25 crd">
                        <?php
                        if(isset($home_section3_pic_data_mob)){
                          foreach ($home_section3_pic_data_mob as $key => $val) {
                            echo '<div class="col-md-6">
                                    <div class="card card-event">
                                      <img src="'.base_url().'/uploads/'.$val->img_link.'" class="card-img-top" alt="">
                                      <div class="card-footer tx-13">
                                        <span class="tx-color-03"></span>
                                        <span class="del-icon">
                                          <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal5" onclick="home_section3_pic_data_mob('.$val->img_id.')"></i>
                                        </span>
                                      </div>
                                    </div>
                                  </div>';
