              ...
              <div class="df-example">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item" onclick="make_active('section1')">
                    ...
                    <a class="nav-link" id="section1-tab" data-toggle="tab" href="#section1" role="tab" aria-controls="section1" aria-selected="true">Leader Board</a>
              ...
              <div class="modal fade" id="exampleModal2">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form" action="" onsubmit="return false">
                        <label for="leadership_banner_text_edit"><b>Banner Title:</b></label>
                        <input type="hidden" id="leadership_banner_edit_id" value="">
                        <input type="text" class="form-control" placeholder="Enter text" id="leadership_banner_text_edit"><br>
                        <label for="leadership_banner_pic_edit"><b id="type_text">Choose Image(1350x400):</b></label>
                        <img src="#" id="show_pic" width="150px;" style="display: none;"><br>
                        <input type="file" id="leadership_banner_pic_edit" accept="image/png, image/jpg, image/jpeg" onchange="document.getElementById('show_pic').src = window.URL.createObjectURL(this.files[0])"><br>
                        <button type="submit" class="btn btn-success" onclick="leadership_banner_edit()">Update</button>
                        <p style="color: red; font-size: 15px;"><b id="home_banner_error"></b></p>
                      </form>
                    </div>
              ...
              <div class="tab-pane fade show" id="section1" role="tabpane2" aria-labelledby="section1-tab">
                <form class="form" action="" onsubmit="return false">
                    ...
                    <div class="headerText">
                      ...
                      <h4 class="mg-b-25">Leader Board Management</h4>

                      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal3">Add New Member</button>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr>
                                ...
                                <td><?php echo $val->linkedin_link;?></td>
                                <td><img src="<?php echo base_url();?>uploads/<?php echo $val->img_link;?>" width="70px;"></td>
                                <td><button class="btn btn-info btn-sm" onclick="leadership_section1_pic_edit_data('<?php echo $val->img_id;?>')" data-toggle="modal" data-target="#exampleModal4"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <label for="leadership_section1_image_name"><b>Name:</b></label>
                      <input type="text" class="form-control" placeholder="Enter Name" id="leadership_section1_image_name" required><br>
                      <label for="leadership_section1_image_text"><b>Text:</b></label>
                      <textarea class="form-control" placeholder="Enter Text" rows="6" id="leadership_section1_image_text" required></textarea><br>
                      <label for="leadership_section1_linkedin_link"><b>Linkedin URL:</b></label>
                      <input type="text" class="form-control" placeholder="Enter Name" id="leadership_section1_linkedin_link"><br>
                      <label for="leadership_section1_image"><b>Choose Image(207x281):</b></label>
                      <img src="#" id="show_pic1" width="150px;" style="display: none;"><br>
                      <input type="file" id="leadership_section1_image" accept="image/png, image/jpg, image/jpeg" onchange="document.getElementById('show_pic1').src = window.URL.createObjectURL(this.files[0]);document.getElementById('show_pic1').style.display = 'block';"><br>
                      <button type="submit" class="btn btn-success" onclick="leadership_section1_image_add()">Add</button>
                      <p style="color: red; font-size: 15px;"><b id="leadership_section1_image_error"></b></p>
                      </form>
                    </div>
              ...
              <div class="modal fade" id="exampleModal4">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form" action="" onsubmit="return false">
                      <input type="hidden" id="leadership_section1_image_id_edit" value="">
                      <label for="leadership_section1_image_name_edit"><b>Name:</b></label>
                      <input type="text" class="form-control" placeholder="Enter Name" id="leadership_section1_image_name_edit" required><br>
                      <label for="leadership_section1_image_text_edit"><b>Text:</b></label>
                      <textarea class="form-control" placeholder="Enter Text" rows="6" id="leadership_section1_image_text_edit" required></textarea><br>
                      <label for="leadership_section1_linkedin_link_edit"><b>Linkedin URL:</b></label>
                      <input type="text" class="form-control" placeholder="Enter Name" id="leadership_section1_linkedin_link_edit"><br>
                      <label for="leadership_section1_image_edit"><b>Choose Image(207x281):</b></label>
                      <img src="#" id="show_pic2" width="150px;" style="display: none;"><br>
                      <input type="file" id="leadership_section1_image_edit" accept="image/png, image/jpg, image/jpeg" onchange="document.getElementById('show_pic2').src = window.URL.createObjectURL(this.files[0])"><br>
                      <button type="submit" class="btn btn-success" onclick="leadership_section1_image_update()">Update</button>
                      <p style="color: red; font-size: 15px;"><b id="leadership_section1_image_error_edit"></b></p>
                      </form>
                    </div>
