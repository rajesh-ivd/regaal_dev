          ...
          <div class="media d-block d-lg-flex">
            ...
            <div class="col-xl-12">
              <div class="row row-sm mg-b-25 crd">
                <?php
                if(isset($achievements_banner_data_desk)){
                  foreach ($achievements_banner_data_desk as $key => $val) {
                    echo '<div class="col-md-6">
                            <div class="card card-event">
                              ...
                              <div class="card-footer tx-13">
                                ...
                                <span class="del-icon">
                                  <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal2" onclick="achievements_banner_edit_data_desk('.$val->img_id.')"></i>
                                </span>
                              </div>
                            </div>
                          </div>';
            ...
            <div class="col-xl-12">
              <div class="row row-sm mg-b-25 crd">
                <?php
                if(isset($achievements_banner_data_mob)){
                  foreach ($achievements_banner_data_mob as $key => $val) {
                    echo '<div class="col-md-6">
                            <div class="card card-event">
                              <img src="'.base_url().'/uploads/'.$val->img_link.'" class="card-img-top" alt="">
                              <div class="card-body tx-13">
                              ...
                              <div class="card-footer tx-13">
                                <span class="tx-color-03"></span>
                                <span class="del-icon">
                                  <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal2" onclick="achievements_banner_edit_data_mob('.$val->img_id.')"></i>
                                </span>
                              </div>
                            </div>
                          </div>';
              ...
              <div class="modal fade" id="exampleModal2">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form" action="" onsubmit="return false">
                      <label for="achievements_banner_text_edit"><b>Banner Title:</b></label>
                      <input type="hidden" id="achievements_banner_edit_id" value="">
                      <input type="text" class="form-control" placeholder="Enter text" id="achievements_banner_text_edit"><br>
                      <label for="achievements_banner_pic_edit"><b id="type_text">Choose Image(1350x400):</b></label>
                      <img src="#" id="show_pic" width="150px;" style="display: none;"><br>
                      <input type="file" id="achievements_banner_pic_edit" accept="image/*" onchange="document.getElementById('show_pic').src = window.URL.createObjectURL(this.files[0])"><br>
                      <button type="submit" class="btn btn-success" onclick="achievements_banner_edit()">Update</button>
                      <p style="color: red; font-size: 15px;"><b id="achievements_banner_error"></b></p>
                      </form>
                    </div>
              ...
              <div class="tab-pane fade show" id="section1" role="tabpane2" aria-labelledby="section1-tab">
                <form class="form" action="" onsubmit="return false">
                    ...
                    <div class="headerText">
                      ...
                      <button type="button" class="btn btn-primary" onclick="achievements_section1_save()">Save</button>
                    </div>


                      <label for="achievements_section1_title"><b>Title:</b></label>
                      <input type="text" class="form-control" placeholder="Enter Title" id="achievements_section1_title" value="<?php echo $achievements_section1_data[0]->element_content;?>" required><br>

                      <label for="achievements_section1_text1"><b>Text 1:</b></label>
                      <textarea class="form-control" placeholder="Enter Text" rows="3" id="achievements_section1_text1" required><?php echo $achievements_section1_data[1]->element_content;?></textarea><br>
                      <label for="achievements_section1_text2"><b>Text 2:</b></label>
                      <textarea class="form-control" placeholder="Enter Text" rows="3" id="achievements_section1_text2" required><?php echo $achievements_section1_data[2]->element_content;?></textarea><br>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <label for="about_section1_pic_edit"><b>Choose Image(225x225):</b></label>
                      <img src="#" id="show_pic2" width="150px;" style="display: none;"><br>
                      <input type="file" id="about_section1_pic_edit" accept="image/*" onchange="document.getElementById('show_pic2').src = window.URL.createObjectURL(this.files[0])"><br>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <input type="file" id="csr_section1_image" accept="image/*" onchange="document.getElementById('show_pic1').src = window.URL.createObjectURL(this.files[0]);document.getElementById('show_pic1').style.display = 'block';"><br>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <img src="#" id="show_pic2" width="150px;" style="display: none;"><br>
                      <input type="file" id="csr_section1_image_edit" accept="image/*" onchange="document.getElementById('show_pic2').src = window.URL.createObjectURL(this.files[0])"><br>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <img src="#" id="show_pic2" width="150px;" style="display: none;"><br>
                      <input type="file" id="section1_icon_pic_edit" accept="image/*" onchange="document.getElementById('show_pic2').src = window.URL.createObjectURL(this.files[0])"><br>
