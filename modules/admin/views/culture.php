          ...
          <div class="media d-block d-lg-flex">
                ...
                <div class="tab-content bd bd-gray-300 bd-t-0 pd-20" id="myTabContent">
                  ...
                  <div class="tab-pane fade show" id="banner" role="tabpanel" aria-labelledby="banner-tab">
                    ...
                    <div class="headerText">
                      ...
                      <h4 class="mg-b-25">Banner Management</h4>
            ...
            <div class="col-xl-12">
              <div class="row row-sm mg-b-25 crd">
                <?php
                if(isset($culture_banner_data_desk)){
                  foreach ($culture_banner_data_desk as $key => $val) {
                    echo '<div class="col-md-6">
                            <div class="card card-event">
                              ...
                              <div class="card-footer tx-13">
                                ...
                                <span class="del-icon">
                                  <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal2" onclick="culture_banner_edit_data_desk('.$val->img_id.')"></i>
                                </span>
                              </div>
                            </div>
                          </div>';
            ...
            <div class="col-xl-12">
              <div class="row row-sm mg-b-25 crd">
                <?php
                if(isset($culture_banner_data_mob)){
                  foreach ($culture_banner_data_mob as $key => $val) {
                    echo '<div class="col-md-6">
                            <div class="card card-event">
                              <img src="'.base_url().'/uploads/'.$val->img_link.'" class="card-img-top" alt="">
                              <div class="card-body tx-13">
                              ...
                              <div class="card-footer tx-13">
                                <span class="tx-color-03"></span>
                                <span class="del-icon">
                                  <i class="fas fa-edit" title="Edit" data-toggle="modal" data-target="#exampleModal2" onclick="culture_banner_edit_data_mob('.$val->img_id.')"></i>
                                </span>
                              </div>
                            </div>
                          </div>';
              ...
              <div class="modal fade" id="exampleModal2">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form" action="" onsubmit="return false">
                      <label for="culture_banner_text_edit"><b>Banner Title:</b></label>
                      <input type="hidden" id="culture_banner_edit_id" value="">
                      <input type="text" class="form-control" placeholder="Enter text" id="culture_banner_text_edit"><br>
                      <label for="culture_banner_pic_edit"><b id="type_text">Choose Image(1350x400):</b></label>
                      <img src="#" id="show_pic" width="150px;" style="display: none;"><br>
                      <input type="file" id="culture_banner_pic_edit" accept="image/png, image/jpg, image/jpeg" onchange="document.getElementById('show_pic').src = window.URL.createObjectURL(this.files[0])"><br>
                      <button type="submit" class="btn btn-success" onclick="culture_banner_edit()">Update</button>
                      <p style="color: red; font-size: 15px;"><b id="culture_banner_error"></b></p>
                      </form>
                    </div>
              ...
              <div class="tab-pane fade show" id="section1" role="tabpane2" aria-labelledby="section1-tab">
                <form class="form" action="" onsubmit="return false">
                    ...
                    <div class="headerText">
                      ...
                      <button type="button" class="btn btn-primary" onclick="culture_section1_save()">Save</button>
                    </div>


                      <label for="culture_section1_title"><b>Title:</b></label>
                      <input type="text" class="form-control" placeholder="Enter Title" id="culture_section1_title" value="<?php echo $culture_section1_data[0]->element_content;?>" required><br>

                      <label for="culture_section1_text1"><b>Text 1:</b></label>
                      <textarea class="form-control" placeholder="Enter Text" rows="3" id="culture_section1_text1" required><?php echo $culture_section1_data[1]->element_content;?></textarea><br>
                      <label for="culture_section1_text2"><b>Text 2:</b></label>
                      <textarea class="form-control" placeholder="Enter Text" rows="3" id="culture_section1_text2" required><?php echo $culture_section1_data[2]->element_content;?></textarea><br>
                      <label for="culture_section1_text3"><b>Text 3:</b></label>
                      <textarea class="form-control" placeholder="Enter Text" rows="3" id="culture_section1_text3" required><?php echo $culture_section1_data[3]->element_content;?></textarea><br>
